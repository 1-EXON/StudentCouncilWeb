    ...
    return (
        <div className="text-center bg-gray-800 px-2 sm:px-4 py-2.5 m-2 rounded">
            ...
            <div className="inline-flex">
                ...
                <button className="rounded bg-transparent font-semibold border-blue-theme mt-3 mx-1 py-2 px-6 border text-blue-theme hover:text-white hover:bg-blue-theme">둘러보기</button>
            </div>
        </div>
    )
}
